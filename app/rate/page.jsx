...
export default function RatingPage() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!feedback.trim())
      return toast.error("Please provide some feedback text");
              ...
              <Card className="border-t-4 border-t-primary shadow-xl overflow-hidden">
                ...
                <CardContent className="space-y-8 pt-6">
                  ...
                  <div className="bg-muted/50 p-6 rounded-2xl relative italic text-muted-foreground text-lg text-center font-medium leading-relaxed">
                    <div className="absolute -top-3 left-6 text-4xl text-primary/20 font-serif">
                      "
                    </div>
                    {myRating.feedback}
                    <div className="absolute -bottom-6 right-6 text-4xl text-primary/20 font-serif">
                      "
                    </div>
                  </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {myRating.designation || "Active Resident"}
                        </p>
                      </div>
                    </div>
                ...
                <form onSubmit={handleSubmit}>
                  <CardContent className="p-8 space-y-8">
                    ...
                    <div className="space-y-4">
                      ...
                      <Input
                        id="designation"
                        placeholder="e.g. Resident of Itahari-10"
                        className="h-14 text-lg p-4 rounded-xl"
                        value={designation}
                        onChange={(e) => setDesignation(e.target.value)}
                      />
                      <p className="text-sm text-muted-foreground px-1">
                        Giving yourself a role makes your feedback more
