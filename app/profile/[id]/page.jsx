        ...
        <div className='min-h-screen bg-slate-50/10 dark:bg-slate-950/10 pb-20'>
            ...
            <div className='container mx-auto px-4 -mt-24 relative z-30 max-w-7xl'>
                ...
                >
                    ...
                    <MetricCard title="Actions" value={stats.total_comments_made || 0} icon={Activity} color="text-blue-500" bg="bg-blue-500/10" description="Community participation" />
                ...
                <div className='w-full'>
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 gap-4 px-2">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-2xl font-black tracking-tight">Public Reports</h2>
                                <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Citizen's community contributions</p>
                            </div>
                        </div>
                        ...
                        {(recent_comments && recent_comments.length > 0) && (
                            <div className="flex items-center gap-2 text-xs font-bold text-muted-foreground uppercase tracking-widest bg-muted/30 px-4 py-2 rounded-full">
                                ...
                                Last active {mounted && recent_comments[0]?.created_at ? format(new Date(recent_comments[0].created_at), "MMM d") : "recently"}
                            </div>
                        )}
                    </div>
                                            ...
                                            <Card className='group h-full overflow-hidden rounded-[2rem] border-0 bg-card/60 backdrop-blur-md hover:shadow-2xl transition-all hover:-translate-y-2 relative flex flex-col'>
                                                ...
                                                <div className="relative aspect-video w-full overflow-hidden bg-muted">
                                                    ...
                                                    <div className="absolute top-4 left-4">
                                                        <Badge variant="secondary" className={cn("border-0 rounded-lg px-3 py-1 font-black text-[10px] uppercase tracking-wider shadow-lg backdrop-blur-md bg-background/80", CATEGORY_COLORS[issue.category.toLowerCase()] || "bg-muted text-foreground")}>
                                                            {issue.category}
                                                        </Badge>
                                                    </div>
                                                </div>
                                                ...
                                                <CardContent className='p-8 flex-1 flex flex-col'>
                                                    ...
                                                    <h3 className='font-black text-xl mb-3 leading-tight group-hover:text-primary transition-colors line-clamp-2'>
                                                        {issue.title}
                                                    </h3>

                                                    <p className="text-sm text-muted-foreground line-clamp-2 mb-8 font-medium leading-relaxed opacity-80 flex-1">
                                                        {issue.description}
                                                    </p>
